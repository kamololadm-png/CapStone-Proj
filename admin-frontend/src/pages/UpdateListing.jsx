...
const UpdateListing = () => {
  ...
  if (fetching) return <p className="page-container">Loading listing...</p>;
  if (!formData) return <p className="page-container error-message">{error || "Listing not found."}</p>;
  ...
  return (
    <div className="page-container">
      <form className="listing-form" onSubmit={handleSubmit}>
        ...
        <input id="images" name="images" value={formData.images} onChange={handleChange} />
